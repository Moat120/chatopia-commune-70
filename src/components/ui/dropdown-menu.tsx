...
// iOS-style shared classes
const iosItemBase = "relative flex cursor-default select-none items-center rounded-lg px-3 py-2.5 text-[13px] outline-none transition-colors duration-150";
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent ref={ref} className={cn(iosContentBase, className)} {...props} />
));
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(iosContentBase, className)}
      {...props}
    />
  </DropdownMenuPrimitive.Portal>
));
